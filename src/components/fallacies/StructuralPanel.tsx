                    ...
                    >
                      ...
                      >
                        <span
                          ...
                          style={{
                            backgroundColor: isHidden ? '#f3f4f6' : `${preferences.customColors?.[markup.id] || markup.color}20`,
                            color: isHidden ? '#9ca3af' : (preferences.customColors?.[markup.id] || markup.color),
                          }}
                        >
