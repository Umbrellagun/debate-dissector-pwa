              ...
              {expandedCategories.has(category) && (
                ...
                >
                  {categoryRhetoric.map(item => {
                    ...
                    const isPinned = preferences.pinnedRhetoric?.includes(item.id);
                    return (
                      <div
                        key={item.id}
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            style={{ backgroundColor: isHidden ? '#d1d5db' : (preferences.customColors?.[item.id] || item.color) }}
                            aria-hidden="true"
                          />
                          <span
                        ...
                        <div className="flex items-center mr-1">
                          <button
                            ...
                            aria-label={
                              isPinned ? `Unpin ${item.name}` : `Pin ${item.name} to toolbar`
                            }
                          >
                            <svg
