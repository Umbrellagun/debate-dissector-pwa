    ...
    <div className="flex flex-col h-full">
          ...
          <div className="mt-1 text-xs text-amber-700 space-y-1">
            {sourceNeededCount > 0 && (
              <div className="flex items-center gap-1">
                ...
                <span>
                  {sourceNeededCount} item{sourceNeededCount !== 1 ? 's' : ''} need sources
                </span>
              </div>
            )}
            {unsupportedCount > 0 && (
              <div className="flex items-center gap-1">
                ...
                <span>
                  {unsupportedCount} unsupported assertion{unsupportedCount !== 1 ? 's' : ''}
                </span>
              </div>
            )}
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {markup.shortcut && (
                          <span className="text-xs text-gray-400 font-mono">{markup.shortcut}</span>
                        )}
                      </div>
                    </button>
                  );
            ...
            <div className="mb-3">
              ...
              >
                ...
                <span className="flex-1">
                  {showCitationForm ? 'Hide source citation' : 'Add source citation'}
                </span>
                <svg
                ...
                <div className="space-y-2 p-2 bg-white rounded border border-gray-200">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex gap-1">
                      {(['unverified', 'verified', 'disputed'] as VerificationStatus[]).map(
                        status => (
                          <button
                            key={status}
                            type="button"
      ...
      <div className="p-3 border-t border-gray-200 bg-gray-50 shrink-0">
        ...
        <p className="text-xs text-gray-400">
          <span className="font-medium">Shortcuts:</span> Alt+C (Claim), Alt+E (Evidence), Alt+S
          (Source Needed)
        </p>
      </div>
    </div>
