...
const populatedStats: AnnotationStats = {
  ...
  totalAnnotations: 6,
  breakdown: [
    { id: 'straw-man', name: 'Straw Man', color: '#EF4444', count: 2, charCount: 120, category: 'informal', type: 'fallacy' },
    { id: 'ad-hominem', name: 'Ad Hominem', color: '#F87171', count: 1, charCount: 80, category: 'informal', type: 'fallacy' },
    { id: 'appeal-to-authority', name: 'Appeal to Authority', color: '#3B82F6', count: 2, charCount: 150, category: 'ethos', type: 'rhetoric' },
    { id: 'claim', name: 'Claim', color: '#8B5CF6', count: 1, charCount: 100, category: 'structural', type: 'structural' },
  ],
  speakerStats: [
    { id: 's1', name: 'Speaker A', color: '#3B82F6', charCount: 600, annotatedCharacters: 240, coveragePercent: 40, paragraphCount: 5, annotationCount: 3, annotationBreakdown: [
      { id: 'straw-man', name: 'Straw Man', color: '#EF4444', type: 'fallacy', count: 2 },
      { id: 'appeal-to-authority', name: 'Appeal to Authority', color: '#3B82F6', type: 'rhetoric', count: 1 },
    ] },
    { id: 's2', name: 'Speaker B', color: '#EF4444', charCount: 400, annotatedCharacters: 160, coveragePercent: 40, paragraphCount: 3, annotationCount: 2, annotationBreakdown: [
