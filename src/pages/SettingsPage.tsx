...
export const SettingsPage: React.FC = () => {
  ...
  const _handleThemeChange = (theme: 'light' | 'dark' | 'system') => {
    updatePreferences({ theme });
  };

  const _handleFontSizeChange = (fontSize: 'small' | 'medium' | 'large') => {
          ...
          <section className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 space-y-3 text-sm text-gray-600">
              ...
              <p className="text-gray-600 font-medium">
                A tool for analyzing debates, identifying logical fallacies, and rhetorical
                strategies.
              </p>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="text-sm text-gray-600 space-y-3">
                  <p>
                    ...
                    I was at a coding bootcamp and had recently left Rutgers where I had been
                    pursuing an English degree. I envisioned a tool where I could physically
                    demonstrate how arguments are structured and where they break down. I wanted to
                    build something that would help people think more clearly about complex issues.
                  </p>
                  <p>
                    I've spent far too many discussions, online or in person, where people talked in
                    circles, avoided addressing issues with statements they've made. It is easy to
                    get turned around in these discussions.
                  </p>
                  <p>So, I created this app.</p>
                  <p>
                    If you like it or have feedback, please reach out! My email is below. If you are
                    inclined to support me and projects I work on there are also links below.
                  </p>
                  <p className="pt-2">
                    Stay awesome,
                    <br />
