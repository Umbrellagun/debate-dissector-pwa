            ...
            <div className="prose prose-sm prose-gray max-w-none space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  Debate Dissector is a Progressive Web App designed for analyzing debates and identifying logical fallacies. 
                ...
                <div className="space-y-3 text-gray-600">
                  <div>
                    ...
                    <p>
                      ...
                      This data never leaves your device unless you explicitly choose to share a document.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>
                      We use Umami, a privacy-focused analytics service, to collect anonymous usage data. 
                      This includes page views and general feature usage. We do not track personal information, 
                      and no cookies are used for tracking purposes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  You can delete your local data at any time by clearing your browser's storage. 
                  For shared documents, you can delete them through the sharing interface.
                </p>
              </div>
